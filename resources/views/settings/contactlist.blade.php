   ...
   <div class="col-md-12">
	   ...
	   <div class="kt-portlet">
                        ...
                        Contact us Content</h3>
										...
										<!--begin::Form-->
										<form class="kt-form" method="POST" action="{{ url('contact/create') }}" >
										@csrf
                        ...
                        <div class="form-group customlink">
                          <label>Phone :</lable> <span>should be like this (+91123456789)</label>
                          <input type="tel" name="phone"  value="<?php if(!empty($editmenu->phone)){ echo $editmenu->phone ; }?>" class="form-control" aria-describedby="emailHelp" placeholder="Enter here" required>
                          <?php
                          if(isset($errors)){
                            ?>
                            <span class="invalid-feed" role="alert">
                              <strong>{{ $errors->getBag('default')->first('phone') }}</strong>
                            </span>
                          <?php
                          }
                           ?>
                        ...
                        <div class="form-group customlink">
                          <label>Email</label>
                          <input type="email" name="email"  value="<?php if(!empty($editmenu->email)){ echo $editmenu->email ; }?>" class="form-control" aria-describedby="emailHelp" placeholder="Enter here" required>
                          <?php
                          if(isset($errors)){
                            ?>
                            <span class="invalid-feed" role="alert">
                              <strong>{{ $errors->getBag('default')->first('email') }}</strong>
                            </span>
                          <?php
                          }
                           ?>
                        ...
                        <div class="form-group customlink">
                          <label>Address</label>
                          <input type="text" name="address"  value="<?php if(!empty($editmenu->address)){ echo $editmenu->address ; }?>" class="form-control" aria-describedby="emailHelp" placeholder="Enter here" required>
                          <?php
                          if(isset($errors)){
                            ?>
                            <span class="invalid-feed" role="alert">
                              <strong>{{ $errors->getBag('default')->first('address') }}</strong>
                            </span>
                          <?php
                          }
                           ?>
                        ...
                        <div class="form-group customlink">
                          <label>Time</label>
                          <input type="text" name="time"  value="<?php if(!empty($editmenu->time)){ echo $editmenu->time ; }?>" class="form-control" aria-describedby="emailHelp" placeholder="Enter here" required>
                          <?php
                          if(isset($errors)){
                            ?>
                            <span class="invalid-feed" role="alert">
                              <strong>{{ $errors->getBag('default')->first('time') }}</strong>
                            </span>
                          <?php
                          }
                           ?>
