					  ...
					  <td style="text-align: center;width:20%;">
							<span>
							   ...
							   <!-- <a href="{{url('menu/menu-details', $menu->id)}}"> 		 -->
								  <span><img width="32"  height="32" src="{{$menu->icon}}"></span>
							   <!-- </a>	   -->
							   <!-- </div> -->
							</span>
						 </td>
                              ...
                              <span></span>
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<a href="{{ url('admin/topmenu/list') }}" class="btn btn-secondary" >Cancel</a>
												</div>
											</div>
										</form>
...
<script>
	...
	function deleteThis(obj, id)
	{
		swal.fire({
			...
			if (result.value) {
				$('.pageloader').show();
				$.ajax({
					url: "<?php echo url('admin/topmenu/delete'); ?>",
					type: 'POST',
	...
	function updateOrder(selectedData) {
		$('.pageloader').show();
		$.ajax({
			url: "<?php echo url('admin/topmenu'); ?>" + '/update-menu-order',
			type: 'POST',
	...
	function FilterMenuList(selectedData) {
		$('.pageloader').show();
		$.ajax({
			url: "<?php echo url('admin/topmenu'); ?>" + '/list?q=',
			type: 'POST',
