         ...
         <ul class="kt-menu__nav ">
            ...
            <li class="kt-menu__section ">
                        ...
                        <li class="kt-menu__item  kt-menu__item--submenu <?php if(Request::url() == url('admin/topmenu/list') || Request::url() == url('admin/middlemenu/list') || Request::url() == url('admin/mainmenu/list') || Request::url() == url('admin/mainmenu/list/'.$parent_id.'/submenu')){ echo 'kt-menu__item--open'; } ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
											...
											</svg></span><span class="kt-menu__link-text">Components</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">Components</span></span></li>
											...
											<li class="kt-menu__item {{ (Request::url() == url('admin/subfooter/list') ? 'kt-menu__item--active' : '') }}" aria-haspopup="true"><a href="{{ url('/admin/subfooter/list') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Sub Footer</span></a></li>
											<li class="kt-menu__item {{ (Request::url() == url('admin/mainfooter/list') ? 'kt-menu__item--active' : '') }}" aria-haspopup="true"><a href="{{ url('/admin/mainfooter/list') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Main Footer</span></a></li>
											<li class="kt-menu__item {{ (Request::url() == url('admin/bottomfooter/list') ? 'kt-menu__item--active' : '') }}" aria-haspopup="true"><a href="{{ url('/admin/bottomfooter/list') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Bottom Footer</span></a></li>
										</ul>
									</div>
                        </li>
                        <li class="kt-menu__item " aria-haspopup="true">
               <a href="{{ url('/admin/settings') }}" class="kt-menu__link ">
                  <span class="kt-menu__link-icon">
                     <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                           <polygon id="Bound" points="0 0 24 0 24 24 0 24"></polygon>
...
<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
   <a href="{{ url('/news/listing') }}" class="kt-menu__link kt-menu__toggle">
      <span class="kt-menu__link-icon">
         <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
               <rect id="bound" x="0" y="0" width="24" height="24"></rect>
      ...
      <span class="kt-menu__link-text">News Blog</span><i class="kt-menu__ver-arrow la la-angle-right"></i>
   </a>
</li>
            ...
            <li class="kt-menu__item  kt-menu__item--submenu menu-toggle-class" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
               <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                  ...
                  <span class="kt-menu__link-text">Menu</span><i class="kt-menu__ver-arrow la la-angle-right"></i>
               </a>
                  <div class="kt-menu__submenu ">
                  <span class="kt-menu__arrow"></span>
                  <ul class="kt-menu__subnav">
